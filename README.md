# Applying time series models (SARIMA, LSTM) to forecast demand and optimize inventory replenishment decisions in e-commerce.
## Tổng quan
...
## Files
### Source code
"Source_code.ipynb": Source code này bao gồm toàn bộ quy trình thực hiện của nhóm bằng Python, bắt đầu từ EDA, Pre-processing đến triển khai 2 mô hình LSTM và SARIMA cuối cùng là so sánh 2 kết quả đánh giá mô hình với nhau.
...
<br>
<br>
“Dashboard.pbix”: File PowerBI mô tả những dữ liệu và phân tích về doanh số và xu hướng thông qua những biểu đồ trong PowerBI
...
## Other:
- "process.draw.io.jpg": hình ảnh toàn bộ quy trình thực hiện
